...
-- Foreign-currency exposure carried on a line (NULL currency = base-currency line).
-- fx_amount is the original foreign magnitude on this line's side; debit/credit hold
-- the base value at the transaction-date rate. Used for period-end FX revaluation.
...
CREATE TABLE IF NOT EXISTS interview_score (
  ...
  technical numeric(4,1),
  experience numeric(4,1),
  communication numeric(4,1),
  motivation numeric(4,1),
  recommendation text,
...
CREATE TABLE IF NOT EXISTS lab_participant (
  ...
  consent_status text NOT NULL DEFAULT 'valid',
...
CREATE TABLE IF NOT EXISTS tender (
  ...
  title text NOT NULL,
  description text,
  method text NOT NULL DEFAULT 'open_domestic',
...
CREATE TABLE IF NOT EXISTS refund_request (
  ...
  amount double precision NOT NULL,
  reason text,
  bank_details text, momo_details text,          -- where the requester wants to be paid
